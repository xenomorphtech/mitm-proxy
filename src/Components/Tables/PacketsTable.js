      ...
      <TableContainer style={{ width: "unset" }}>
        <Table className={classes.table} size="small" aria-label="simple table">
          ...
          <TableBody>
            {list.map((line, i) => (
              <TableRow key={i}>
                <TableCell align="left" className={classes.addressCell + " font-source-code-pro"}>
                  {makeAddressStr(i)}
                </TableCell>
                <TableCell align="left" className={classes.packetsCell + " font-source-code-pro"}>
                  <ChunkHex chunk={line.match(/.{1,2}/g)} />
                </TableCell>
                <TableCell align="left" className={classes.asciiCell + " font-source-code-pro"}>
                  <AsciiView ascii={C.hexToAscii(line)} />
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
